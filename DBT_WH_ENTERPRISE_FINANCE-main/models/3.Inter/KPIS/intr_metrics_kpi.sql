...
select  
        ...
        z.METRIC_DATE,
        dt.DATECODE as DIM_METRIC_DATE_ID,
        z.METRIC_KPI_VALUE,
        ...
        z.ROW_MOD_DT,
        z.ROW_MOD_USR_ID
from {{ref('stg_metrics_kpi_manual')}} z
        inner join {{ref('metrics')}} me on me.src_uniq_cd = z.src_uniq_cd_METRIC_ID
        inner join {{source('calendar_sources','DATE')}} dt on dt.src_uniq_cd = z.src_uniq_cd_METRIC_DATE_ID     
        left outer join
